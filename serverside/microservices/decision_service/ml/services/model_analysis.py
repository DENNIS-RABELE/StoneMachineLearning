...
from ..models import ClusteringModel, MLMetrics, BettorCluster, ClusterCharacteristics
...
class ClusterAnalyzer:
    ...
    def analyze_cluster_transitions(
        ...
        old_dict = {a.bettor_profile.bettor_id: a.cluster_id for a in old_assignments}
        new_dict = {a.bettor_profile.bettor_id: a.cluster_id for a in new_assignments}
...
class ModelEvaluationService:
    ...
    def evaluate_model_stability(clustering_model: ClusteringModel,
        ...
        max_variance = len(cluster_sizes) * 1000
